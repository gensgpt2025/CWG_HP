...
const projects = [
    ...
    },
    {
        ...
        categoryColor: "text-gold",
        description: <>WEBデザイン、システム開発、SNS運用代行からAI活用コンサルティングまで。<br />最新技術とクリエイティブを融合させ、ビジネスの可能性を最大化します。<br />お気軽にお問い合わせください。</>,
    ...
    },
    {
        ...
        categoryColor: "text-gold",
        description: <>千葉県フットサルリーグに参戦するフットサルクラブの運営。<br />「本気の先へ」を掲げ、スポーツを通じた地域活性化と夢の実現をサポートします。<br />練習試合、練習参加お問い合わせください。</>,
